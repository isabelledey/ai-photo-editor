...
function tn(t2, e2, n2, r2, i2) {
  if (null !== (e2 = en(t2.v, e2, n2, i2)) || r2 && t2.m !== ut)
    return e2;
}
...
function mn(t2) {
  if (j)
    return t2[W] ?? (t2[W] = /* @__PURE__ */ new Map());
  if (W in t2)
    return t2[W];
...
var Pr = class {
  ...
  j() {
    ...
    if (j && r2 && null != ((_a2 = e2[r2]) == null ? void 0 : _a2[n2]) && B(K, 3), e2 = t2.g, Z && z && void 0 === Z && (r2 = (n2 = this.v)[z]) && (r2 = r2.da))
      try {
        r2(n2, e2, Me);
      } catch (t3) {
        u(t3);
...
var hi = Or(function(t2, e2, n2, r2, i2) {
  if (2 !== t2.h)
    return false;
  if (t2 = Wt(t2 = Qn(t2, Ge([void 0, void 0], r2), i2)), i2 = mt(r2 = 0 | e2[et]), 2 & r2)
    throw Error();
  let s2 = en(e2, n2, i2);
  if (s2 instanceof be)
    0 != (2 & s2.J) ? (s2 = s2.V(), s2.push(t2), rn(e2, r2, n2, s2, i2)) : s2.Ma(t2);
...
var bi = oi(function(t2, e2, n2) {
  ...
  if (e2 = function(t3) {
    ...
    if (re(t3)) {
      if ("string" === e3)
        return e3 = $t(Number(t3)), Yt(e3) && e3 >= 0 ? t3 = String(e3) : (-1 !== (e3 = t3.indexOf(".")) && (t3 = t3.substring(0, e3)), (e3 = "-" !== t3[0] && ((e3 = t3.length) < 20 || 20 === e3 && t3 <= "18446744073709551615")) || (Xt(t3), t3 = Gt(Ft, Mt))), t3;
      if ("number" === e3)
...
function Ko(t2) {
  ...
  if ((e2 = (_a2 = wn(t2, bs, 4)) == null ? void 0 : _a2.l()) && (s2.boundingBox = { originX: Rn(e2, 1, Qe) ?? 0, originY: Rn(e2, 2, Qe) ?? 0, width: Rn(e2, 3, Qe) ?? 0, height: Rn(e2, 4, Qe) ?? 0, angle: 0 }), (_b = wn(t2, bs, 4)) == null ? void 0 : _b.g().length)
    for (const e3 of wn(t2, bs, 4).g())
      s2.keypoints.push({ x: tn(e3, 1, void 0, Qe, Qt) ?? 0, y: tn(e3, 2, void 0, Qe, Qt) ?? 0, score: tn(e3, 4, void 0, Qe, Qt) ?? 0, label: ge(tn(e3, 3, void 0, Qe)) ?? "" });
  return s2;
}
function Yo(t2) {
  const e2 = [];
...
var _a = class {
  ...
  l(t2, e2 = true) {
    ...
    if (e2) {
      ...
      if (!(((_c2 = wn(this.baseOptions, zs, 1)) == null ? void 0 : _c2.g()) || ((_d = wn(this.baseOptions, zs, 1)) == null ? void 0 : _d.l()) || ((_e2 = t2.baseOptions) == null ? void 0 : _e2.modelAssetBuffer) || ((_f = t2.baseOptions) == null ? void 0 : _f.modelAssetPath)))
...
var yc = class extends _a {
  ...
  l(t2, e2 = true) {
    if ("runningMode" in t2 && nn(this.baseOptions, 2, te(!!t2.runningMode && "IMAGE" !== t2.runningMode)), void 0 !== t2.canvas && this.g.i.canvas !== t2.canvas)
...
function Cc(t2, e2 = true) {
  ...
  for (const i2 of t2) {
    ...
    for (const n3 of r2.g())
      r2 = e2 && null != Rn(n3, 1) ? Rn(n3, 1) ?? 0 : -1, t2.push({ score: Fn(n3, 2) ?? 0, index: r2, categoryName: ge(tn(n3, 3)) ?? "" ?? "", displayName: ge(tn(n3, 4)) ?? "" ?? "" });
    n2.push(t2);
  }
  return n2;
}
var Oc = class extends yc {
  ...
  o(t2) {
    ...
    if (Mn(this.A, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Pn(this.A, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Pn(this.u, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Pn(this.D, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      ...
      void 0 === t2.cannedGesturesClassifierOptions && ((_b = wn(this.h, io, 3)) == null ? void 0 : _b.g());
...
var Jc = class extends yc {
  ...
  segment(t2, e2, n2, r2) {
    const i2 = "function" != typeof n2 ? n2 : {};
    if (this.j = "function" == typeof n2 ? n2 : r2, this.qualityScores = this.categoryMask = this.confidenceMasks = void 0, n2 = this.C + 1, r2 = new Uo(), e2.keypoint && e2.scribble)
